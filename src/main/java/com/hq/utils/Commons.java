...
public class Commons {
    ...
    public static String site_option(String key, String defalutValue) {
        ...
        String str = Constants.initConfig.get(key);
    ...
    public static String parsedate_zh_y_m(String date){
        if (StringUtils.isNotBlank(date)){
            Date d = DateUtil.dateFormat(date, "yyyy年MM月");
            return DateUtil.dateFormat(d, "yyyy");
        }
        return null;
    }
    ...
    public static Date fmtdate_unxtime(Integer nuixTime){
        if (null != nuixTime){
            return DateUtil.getDateByUnixTime(nuixTime);
        }
        return  null;
    }
    /**
    ...
    public static Map<String, String> social() {
        ...
        map.put("csdn", Constants.initConfig.get(prefix + "csdn"));
        map.put("jianshu", Constants.initConfig.get(prefix + "jianshu"));
        map.put("resume", Constants.initConfig.get(prefix + "resume"));
        map.put("weibo", Constants.initConfig.get(prefix + "weibo"));
        map.put("zhihu", Constants.initConfig.get(prefix + "zhihu"));
        map.put("github", Constants.initConfig.get(prefix + "github"));
        map.put("twitter", Constants.initConfig.get(prefix + "twitter"));
        return map;
    }
    ...
    public static String article(String value) {
        if (StringUtils.isNotBlank(value)) {
            ...
            value = value.replace("<!-- more -->", "\r\n");
            return ToolUtil.mdToHtml(value);
        }
        return "";
    }
    ...
    public static String show_thumb(String content) {
        content = ToolUtil.mdToHtml(content);
    ...
    public static String intro(String value, int len) {
        ...
        if (pos != -1) {
            ...
            return ToolUtil.mdToHtml(ToolUtil.mdToHtml(html));
        } else {
            String text = ToolUtil.mdToHtml(ToolUtil.mdToHtml(value));
            if (text.length() > len) {
